...
function validateMatch(match){
  ...
  return { gameId:String(match.gameId), gameCreation:Number(match.gameCreation)||Date.now(), duration:Number(match.duration)||0, gameMode:String(match.gameMode||"CUSTOM"), gameType:String(match.gameType||"CUSTOM_GAME"), queueId:Number(match.queueId)||0, participants, timelineCollected:Boolean(match.timelineCollected), epicObjectives:normalizeEpicObjectives(match.epicObjectives,participants), uploadedAt:Date.now() };
}
